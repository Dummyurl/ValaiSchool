...
import com.valai.school.fragmentsStaff.HomeFragmentStaff;
import com.valai.school.fragmentsStaff.MessageFragmentStaff;
...
import static com.valai.school.utils.AppConstants.ROOT_STAFF_PHOTO_FOLDER;
...
import static com.valai.school.utils.CommonUtils.writeStaffResponseBodyToDisk;
...
public class TeacherActivity extends BaseActivity implements DrawerLocker, FragmentListnerStaff, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityTitles = getResources().getStringArray(R.array.nav_item_staff_titles);
        staffImg.setVisibility(View.VISIBLE);
        ...
        if (listSignInRes != null && listSignInRes.size() > 0) {
            ...
            if (listSignInRes.get(0).getStaffImg() != null && !listSignInRes.get(0).getStaffImg().equals("")) {
                Glide.with(this)
                        .load(ROOT_DOWNLOAD + ROOT_GROUP_FOLDER + listSignInRes.get(0).getOrgId() + ROOT_STAFF_PHOTO_FOLDER + listSignInRes.get(0).getStaffImg())
                        //.error(R.mipmap.student_icon)
                        .diskCacheStrategy(DiskCacheStrategy.NONE)
                        .signature(new StringSignature(String.valueOf(System.currentTimeMillis())))
                        //.placeholder(R.mipmap.student_icon)
...
//            case 0:
//                // HomeFragmentStaff
//                return new HomeFragmentStaff();
            case 0:
                // MessageFragmentStaff
                return new MessageFragmentStaff();
            case 1:
                // AttendanceFragmentStaff
                return new AttendanceFragmentStaff();
            default:
                // By Default MessageFragmentStaff
                return new MessageFragmentStaff();
        }
    }
...
//                        break;
                    ...
                    case R.id.nav_logout:
                        ...
                        Intent intent = LogInActivity.getStartIntent(TeacherActivity.this);
                    ...
                    if (response.isSuccessful()) {
                        new AsyncTask<Void, Boolean, Boolean>() {
                            ...
                            protected Boolean doInBackground(Void... booleans) {
                                ...
                                return writeStaffResponseBodyToDisk(TeacherActivity.this, response.body(), directoryName, fileNames, fragmentListner);
                            }
                            ...
                            protected void onPostExecute(Boolean aBoolean) {
                                ...
                                if (!aBoolean) {
                                    ...
                                    CommonUtils.openFile(TeacherActivity.this, outputFile);
