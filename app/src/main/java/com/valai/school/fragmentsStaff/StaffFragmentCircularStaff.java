...
public class StaffFragmentCircularStaff extends BaseFragment implements FragmentListnerCircularAdmin {
    ...
    public StaffFragmentCircularStaff() {
        // Required empty public constructor
    }

    public static StaffFragmentCircularStaff newInstance(String param1, String param2) {
        StaffFragmentCircularStaff fragment = new StaffFragmentCircularStaff();
    ...
    public void Next() {
        if (stringArrayList != null && stringArrayList.size() > 0) {
            Intent i = new Intent(getActivity(), CircularStaffDetailStaff.class);
    ...
    private void setAdapter() {
        if (getCircularStaffPOJOArrayList != null && getCircularStaffPOJOArrayList.size() > 0) {
            ...
            circularStaffAdapter = new CircularStaffAdapterStaff(getContext(), getCircularStaffPOJOArrayList, fragmentListnerCircularAdmin, fragmentListner);
