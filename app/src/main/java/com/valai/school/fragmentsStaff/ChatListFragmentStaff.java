...
public class ChatListFragmentStaff extends BaseFragment {
    public static final String TAG = ChatListFragmentStaff.class.getSimpleName();
    ...
    public ChatListFragmentStaff() {
        // Required empty public constructor
    }

    public static ChatListFragmentStaff newInstance(String param1, String param2) {
        ChatListFragmentStaff fragment = new ChatListFragmentStaff();
