...
import com.valai.school.activityStaff.AssignmentDetailStaff;
...
public class AssignmentFragmentStaff extends BaseFragment {
    public static final String TAG = AssignmentFragmentStaff.class.getSimpleName();
    ...
    public AssignmentFragmentStaff() {
        // Required empty public constructor
    }

    public static AssignmentFragmentStaff newInstance(String param1, String param2) {
        AssignmentFragmentStaff fragment = new AssignmentFragmentStaff();
        ...
        recycler_view.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView Recyclerview, MotionEvent motionEvent) {
                ...
                if (ChildView != null && gestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    Intent i = new Intent(getActivity(), AssignmentDetailStaff.class);
