...
public class AssignmentDetailStaff extends BaseActivity implements GetFileDownload {
    public static final String TAG = AssignmentDetailStaff.class.getSimpleName();
    ...
    public void Send(View view) {
        Intent i = new Intent(this, AssignmentSendStaff.class);
