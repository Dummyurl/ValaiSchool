 ...
 */
public class HolidayCalendarAdapter extends BaseAdapter implements View.OnClickListener {
    private static final String tag = "HolidayCalendarAdapter";
    ...
    public HolidayCalendarAdapter(Context context, int textViewResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        for (int i = 0; i < date_collection_arr.size(); i++) {
            ...
            if (list.get(position).equals(new SimpleDateFormat("dd-MMMM-yyyy").format(date1))) {
                if (cal_obj.event_message.equals("Active")) {
            ...
            for (int i = 0; i < list.size(); i++) {
                try {
                    ...
                    if (MyDate1.contains("Sunday")) {
                        Date date1 = new SimpleDateFormat("EEEE d MMM yyyy").parse(MyDate1);
                        String change_date = new SimpleDateFormat("dd-MMMM-yyyy").format(date1);
