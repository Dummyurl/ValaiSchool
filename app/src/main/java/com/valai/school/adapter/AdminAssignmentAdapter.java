...
public class AdminAssignmentAdapter extends RecyclerView.Adapter<AdminAssignmentAdapter.MyViewHolder> {
    private Context ctx;
    private List<GetAdminAssignmentPOJO.Datum> getAssignmentArrayList;
    ...
    public AdminAssignmentAdapter(Context ctx, List<GetAdminAssignmentPOJO.Datum> getAssignmentArrayList,
                                  List<SignInPOJO.Datum> listSignInRes, GetFileDownload fileDownload) {
        this.ctx = ctx;
    ...
    public void onBindViewHolder(final MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        if (getAssignmentArrayList.get(position).getFileName() == null &&
                ...
                getAssignmentArrayList.get(position).getSubject() == null &&
                getAssignmentArrayList.get(position).getSubject().equals("")) {
            ...
            holder.image_download.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View view) {
                    if (fileDownload.isInterNetConnected()) {
                        if (getAssignmentArrayList.get(Integer.parseInt(view.getTag().toString())).getGenFilename() != null) {
                            ...
                            // fragmentListner.setAssignmentList(getAssignmentArrayList);
