...
public class CircularClassAdapterStaff extends RecyclerView.Adapter<CircularClassAdapterStaff.MyViewHolder> {
    ...
    public CircularClassAdapterStaff(Context ctx, List<GetCircularClassPOJO.Datum> datumArrayList,
                                     FragmentListnerCircularAdmin fragmentListnerCircularAdmin, FragmentListnerStaff fragmentListner) {
        this.ctx = ctx;
