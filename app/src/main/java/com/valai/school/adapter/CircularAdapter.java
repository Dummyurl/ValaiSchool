...
public class CircularAdapter extends RecyclerView.Adapter<CircularAdapter.MyViewHolder> {
    ...
    private Context ctx;
    private List<GetCircularPOJO.Datum> datumArrayList;
    ...
    public CircularAdapter(Context ctx, List<GetCircularPOJO.Datum> datumArrayList,
                           List<StudentListPOJO.Datum> listStudentRes, GetFileDownload circularFileDownload,
                           FragmentListner fragmentListner, HashMap<Integer, List<GetCircularPOJO.Datum>> hashMapDataList) {
        this.ctx = ctx;
            ...
            holder.image_download.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View view) {
                    ...
                    if (circularFileDownload.isInterNetConnected()) {
                        ...
                        if (!datumArrayList.get(Integer.parseInt(view.getTag().toString())).getGenfileName().equals("null")) {
                            ...
                            hashMapDataList.put(listStudentRes.get(0).getStudentId(), datumArrayList);
