...
public class CircularStaffAdapterStaff extends RecyclerView.Adapter<CircularStaffAdapterStaff.MyViewHolder> {

    private Context ctx;
    private List<GetCircularStaffPOJO.Datum> datumArrayList;
    ...
    public CircularStaffAdapterStaff(Context ctx, List<GetCircularStaffPOJO.Datum> datumArrayList, FragmentListnerCircularAdmin fragmentListnerCircularAdmin, FragmentListnerStaff fragmentListner) {
        this.ctx = ctx;
    ...
    public void onBindViewHolder(final MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.text_name.setText(datumArrayList.get(position).getTeacherName());
        ...
        holder.checkbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                ...
                if (isChecked) {
                    ...
                    modal.setUserId(datumArrayList.get(position).getStaffId());
