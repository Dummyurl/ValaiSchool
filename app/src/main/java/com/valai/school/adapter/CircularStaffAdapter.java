...
public class CircularStaffAdapter extends RecyclerView.Adapter<CircularStaffAdapter.MyViewHolder> {
    ...
    public CircularStaffAdapter(Context ctx, List<GetCircularStaffPOJO.Datum> datumArrayList, FragmentListnerCircularAdmin fragmentListnerCircularAdmin, FragmentListnerAdmin fragmentListner) {
        this.ctx = ctx;
