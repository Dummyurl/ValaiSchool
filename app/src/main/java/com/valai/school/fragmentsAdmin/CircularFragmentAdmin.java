...
public class CircularFragmentAdmin extends BaseFragment {
    public static final String TAG = CircularFragmentAdmin.class.getSimpleName();
    ...
    public CircularFragmentAdmin() {
        // Required empty public constructor
    }

    public static CircularFragmentAdmin newInstance(String param1, String param2) {
        CircularFragmentAdmin fragment = new CircularFragmentAdmin();
