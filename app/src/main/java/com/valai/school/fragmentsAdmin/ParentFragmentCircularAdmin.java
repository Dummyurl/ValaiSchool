...
public class ParentFragmentCircularAdmin extends BaseFragment implements FragmentListnerCircularAdmin {
    public static final String TAG = ParentFragmentCircularAdmin.class.getSimpleName();
    ...
    private CircularClassAdapter circularClassAdapter;

    public ParentFragmentCircularAdmin() {
        // Required empty public constructor
    }

    public static ParentFragmentCircularAdmin newInstance(String param1, String param2) {
        ParentFragmentCircularAdmin fragment = new ParentFragmentCircularAdmin();
    ...
    public void Next() {
        if (stringArrayList != null && stringArrayList.size() > 0) {
            Intent i = new Intent(getActivity(), CircularParentDetailAdmin.class);
    ...
    private void setAdapter() {
        if (getCircularClassPOJOArrayList != null && getCircularClassPOJOArrayList.size() > 0) {
            ...
            circularClassAdapter = new CircularClassAdapter(getContext(), getCircularClassPOJOArrayList, fragmentListnerCircularAdmin, fragmentListner);
