...
public class AttendanceFragmentAdmin extends BaseFragment {
    ...
    public AttendanceFragmentAdmin() {
        // Required empty public constructor
    }

    public static AttendanceFragmentAdmin newInstance(String param1, String param2) {
        AttendanceFragmentAdmin fragment = new AttendanceFragmentAdmin();
